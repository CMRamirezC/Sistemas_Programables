...
![MapaConceptual](../Imagenes/C2.2_MapaConceptual.png)
...
R: Al arduino se le conecta con la salida de 5 volts el cual suministra el voltaje a los relés para obtener los 24 volts que se necesitan.

En este sistema se observan tamnbién relés, electrovalvulas, arduino.  
...
R: Motores paso a paso que se utilizan para realizar movimiento en los ejes x, y, z del extrusor de la impresora 3d, Motor extrusor que moldea el plastico para realizar la impresión 3d.
